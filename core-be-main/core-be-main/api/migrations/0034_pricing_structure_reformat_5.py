# Generated by Django 4.2.1 on 2023-07-24 14:00
import json

from django.db import migrations


def migrate_pricing_structure_format5(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("api", "0033_pricing_structure_reformat_4"),
    ]

    operations = [migrations.RunPython(migrate_pricing_structure_format5), ]
