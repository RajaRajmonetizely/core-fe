# Generated by Django 4.2.1 on 2023-09-07 14:09

import json
from django.db import migrations


def migrate_pricing_structure_format9(apps, schema_editor):
        ...
        if fields["Output"]:
            if name == "Linear Model":
                ...
                def two_part_formula_minimum_commit(metric, lookup_value):
                    for item in rows:
                        if item[metric]["low"] <= lookup_value <= item[metric]["high"]:
                            return (item["transaction_fee"] * item["transaction_fee"]) + (lookup_value * item["platform_fee"])
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(migrate_pricing_structure_format9)]
