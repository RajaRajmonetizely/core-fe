# Generated by Django 4.2.1 on 2023-07-10 06:56
import json

from django.db import migrations


def migrate_pricing_structure_format2(apps, schema_editor):
    ...
    for item in data:
        ...
        if fields["Output"]:
            if name == "Linear Model":
                ...
                formula = (
                    "LOOKUP[metric_range: (transaction_fee * units) + platform_fee]"
                )
        ...
        if name == "Two Part formula with minimum commit":
            custom_formula = "LOOKUP[metric_range: (transaction_fee * units) + (transaction_fee * minimum_committed_units)]"
...
class Migration(migrations.Migration):
    dependencies = [
        ("api", "0018_alter_feature_external_description_and_more"),
    ]

    operations = [
        migrations.RunPython(migrate_pricing_structure_format2),
    ]
