# Generated by Django 4.2.1 on 2023-08-09 09:30
import json
from django.db import migrations

def migrate_pricing_structure_format7(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("api", "0047_pricing_structure_reformart_6"),
    ]

    operations = [
        migrations.RunPython(migrate_pricing_structure_format7),
    ]
