# Generated by Django 4.2.1 on 2023-07-21 06:49
...
def migrate_pricing_structure_format3(apps, schema_editor):
    ...
    for item in data:
        ...
        if fields["Output"]:
            if name == "Linear Model":
                ...
                formula = (
                    "LOOKUP[metric_range: (transaction_fee * metric_range) + platform_fee]"
                )
...
class Migration(migrations.Migration):
    dependencies = [
        ("api", "0030_rename_account_ext_id_account_account_ext_ids_and_more"),
    ]

    operations = [
        migrations.RunPython(migrate_pricing_structure_format3),
    ]
