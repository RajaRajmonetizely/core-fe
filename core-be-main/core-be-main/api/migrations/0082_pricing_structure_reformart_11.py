...
def migrate_pricing_structure_format11(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("api", "0081_alter_contractsignature_status"),
    ]

    operations = [migrations.RunPython(migrate_pricing_structure_format11)]
